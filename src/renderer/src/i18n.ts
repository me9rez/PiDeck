...
const zhCN = {
  ...
  "app.resend": "重发",
  "app.resendTitle": "从该消息继续（同会话截断后重发，不新建会话文件）",
  "app.resendCancelled": "重发已取消",
  "app.resendFailed": "重发失败：{error}",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "app.composerEnterPlaceholder":
    "Type a message. Enter sends. & sessions, @ files, / commands, ! shell",
  ...
  "app.composerShortcutPlaceholder":
    "Type a message. Use your shortcut to send. & sessions, @ files, / commands, ! shell",
  ...
  "app.resend": "Resend",
  "app.resendTitle": "Continue from this message in the same session file (truncate then resend)",
  "app.resendCancelled": "Resend cancelled",
  "app.resendFailed": "Resend failed: {error}",
